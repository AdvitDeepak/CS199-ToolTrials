...
class Toolformer(nn.Module):
    ...
    def filter_and_keep_only_first_api_call(
        ...
        print("ADDED IN: ENTERED FILTERED FUNCTION")
        print(data)
        print("=====")
        print(data_with_api_calls)
        included_data = []
        ...
        print("CALLING SECOND PARTIAL FUNC")
        ...
        if not return_excluded:
            print(f"RETURNED EARLY: incl {included}")
            return included
        print(f"ADDED IN: incl {included}, excl {excluded}")
